...
public class Formats {
    ...
    public String Colorformat(String output) {
        ...
        String f17 = f16.replace("&r", "§r");
        String f18 = f17.replace("&k", "§k");
        String f19 = f18.replace("&l", "§l");
        String f20 = f19.replace("&m", "§m");
        String f21 = f20.replace("&n", "§n");
        String back = f21.replace("&o", "§o");
